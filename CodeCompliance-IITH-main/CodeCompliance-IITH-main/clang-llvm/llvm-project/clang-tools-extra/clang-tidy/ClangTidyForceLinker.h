...
// This anchor is used to force the linker to link the ComplianceModule
extern volatile int ComplianceModuleAnchorSource;
static int LLVM_ATTRIBUTE_UNUSED ComplianceModuleAnchorDestination =
    ComplianceModuleAnchorSource;
