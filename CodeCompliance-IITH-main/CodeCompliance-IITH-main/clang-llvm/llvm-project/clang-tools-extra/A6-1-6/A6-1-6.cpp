...
StatementMatcher gotoStatement = gotoStmt().bind("goto");
...
public:
  ...
  virtual void run(const MatchFinder::MatchResult &Result) override {
    ...
    if (const clang::GotoStmt *expre = Result.Nodes.getNodeAs<clang::GotoStmt>("goto")){
        ...
        Diagnostics.Report(expre ->getBeginLoc(), DiagID);
