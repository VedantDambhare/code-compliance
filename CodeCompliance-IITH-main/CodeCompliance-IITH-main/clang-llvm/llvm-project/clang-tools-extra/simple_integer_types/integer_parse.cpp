...
DeclarationMatcher varDeclMatcher = varDecl(hasType(isInteger())).bind("intvar");
...
public:
  ...
  virtual void run(const MatchFinder::MatchResult &Result) override {
     if (const VarDecl *FD =Result.Nodes.getNodeAs<VarDecl>("intvar")) {
     
      outs()<< "variable name" << FD->getNameAsString() << "\n";
    }
